...
import type Route1 from "/root/dev/elysiakit/src/routes/api/[...catchall]/teams/[id]";
import type Route2 from "/root/dev/elysiakit/src/routes/api/[...catchall]/groups/[id]";
...
declare global {
    export type Routes = ElysiaWithBaseUrl<"/", ReturnType<typeof Route0>>
              & ElysiaWithBaseUrl<"/teams/:id", ReturnType<typeof Route1>>
              & ElysiaWithBaseUrl<"/groups/:id", ReturnType<typeof Route2>>
